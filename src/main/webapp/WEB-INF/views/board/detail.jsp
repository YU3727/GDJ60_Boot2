                    ...
                    <div class="col-lg-9">
                        ...
                        <article>
                            ...
                            <section class="mb-5">
                                ...
                                <!-- project 내부의 경로이기 떄문에 외부 파일을 가져오기 힘듦 -->
                                <!-- 230419 detail, 파일출력과 강사님 notion SpringBoot - file관리 참고 -->
                                <!-- WebConfig.java, application.properties 수정 필요. -->
                                <c:forEach items="${boardVO.boardFileVOs}" var="boardFileVO">
	                                <img alt="" src="/file/${board}/${boardFileVO.fileName}">
	                                <!-- FileManager에 CustomView를 만듦 -->
